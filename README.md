...
| **VCM – VAT Compliance Monitor** | [GitHub Repo](https://github.com/kevindellapiazza/vat-compliance-monitor) | AWS (Bedrock, Textract, SAM, Lambda), IAM Security, Python, Glue/Athena | Hybrid AI Pipeline (Textract + Claude 3) for semantic extraction, achieving compliance-grade accuracy. Automated FinTech workflow reducing manual risk at an estimated cost of ~$18 per 10,000 invoices. Designed for Zero Data Retention (FADP/GDPR). |
...
| **Secure FinTech API** | [GitHub Repo](https://github.com/kevindellapiazza/aws-fargate-fintech-demo) | **AWS Fargate**, **ECS**, **Terraform**, **VPC**, **IAM**, **Python FastAPI** | A secure, containerized microservice architecture designed for high availability. Features a custom VPC network, least-privilege IAM roles, and automated ECR image scanning. |
